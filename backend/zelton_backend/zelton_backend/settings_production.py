...
SECURE_SSL_REDIRECT = False  # Disable automatic HTTPS redirect to allow nginx to handle it
...
PHONEPE_REQUEST_TIMEOUT = config('PHONEPE_REQUEST_TIMEOUT', default=30, cast=int)
